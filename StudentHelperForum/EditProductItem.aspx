<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditProductItem.aspx.cs" Inherits="StudentHelperForum.EditProductItem" %>
    ...
    <div class="row d-flex d-md-block flex-nowrap wrapper">
        ...
        <main class="col-md-10 float-left col px-5 px-md-3 py-3 main">
          ...
          <li class='list-group-item active' aria-current='true'>Edit Product</li>
            <li class='list-group-item' id="ReturnProdName" runat="server"> </li>
            <li class='list-group-item' id="ReturnProdPrice" runat="server"> </li>
            <li class='list-group-item' id="ReturnProdDescription" runat="server"> </li>
           </ul>
            ...
            <div style="width:300px;margin-left:35%;margin-top:5%;margin-bottom:20%;">
                              ...
                              <form class="row contact_form" runat="server" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" runat="server" id="ProductName" name="ProductName" value=""
                                        placeholder="Product Name">
                                </div>

                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" runat="server" id="ProductPrice" name="ProductPrice" value=""
                                        placeholder="Product Price">
                                </div>


                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" runat="server" id="ProductDescription" name="ProductDescription" value=""
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <asp:Button class="btn_3" OnClick="Update_Good" runat="server" Text="Update Product" ID="BTN5"/>
