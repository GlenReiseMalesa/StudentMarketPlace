        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (ProductCart prod in PCLs)
            {
                ...
                if (userId.Equals(prod.sNUM)) {
                    ...
                    display += "<a class='btn_1' style='background-color:blue;' href='UpdateCartProduct.aspx?index=" + prod.CartID + "'>Update</a>";
                    display += "</div>";
                    display += " </td>";

                    display += "<td>";
                    display += "<div class='cupon_text float-right' >";
                    display += "<a class='btn_1' style='background-color:red;' href='RemoveProduct.aspx?index="+prod.CartID+"'>X</a>";
                    display += "</div>";
                    display += " </td>";
                    display += "</tr>";
                }
            ...
            foreach (ServiceCart service in SCLs)
            {
                ...
                if (userId.Equals(service.sNUM))
                {
                    ...
                    display += "<td>";
                    display += "<div class='cupon_text ' >";
                    display += "<a class='btn_1' style='background-color:blue;' href='RemoveService.aspx?index=" + service.CartID + "'>Update</a>";
                    display += "</div>";
                    display += " </td>";

                    display += "<td>";
                    display += "<div class='cupon_text float-right' >";
                    display += "<a class='btn_1' style='background-color:red;' href='RemoveService.aspx?index=" + service.CartID+ "'>X</a>";
                    display += "</div>";
                    display += " </td>";
                    display += "</tr>";
                }
            ...
            checkoutDisplay += "<a class='btn_1 checkout_btn_1' href='Checkout.aspx?studentNumber="+ userId + "'>Proceed to checkout</a>";

            checkoutBtn.InnerHtml = checkoutDisplay;
    }
    }
}